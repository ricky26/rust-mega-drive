    ...
    loop {
        ...
        // Draw Text
        {
            ...
            for (idx, tile_id) in TILE_INDICES.iter().cloned().enumerate() {
                ...
                let mut sprite = Sprite::with_flags(TileFlags::for_tile(tile_id, 0), SpriteSize::Size1x1);
        ...
        // Draw pong.
        {
            let mut s = Sprite::with_flags(TileFlags::for_tile(11, 0), SpriteSize::Size1x2);
            s.set_priority(true);
            ...
            // Ball
            let mut s = Sprite::with_flags(TileFlags::for_tile(10, 0), SpriteSize::Size1x1);
            s.set_priority(true);
        ...
        // Update pong.
        {
            ...
            if hit {
                ...
                // Not sure why but this is currently needed to avoid the keys getting stuck. :(
                screen_hit.set_key(false);
            }
        }
